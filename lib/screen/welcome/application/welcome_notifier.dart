...
class WelcomeNotifier extends StateNotifier<WelcomeState> {
  WelcomeNotifier(this._dio, this._hiveDataBase) : super(const WelcomeState());

  final HiveDatabase _hiveDataBase;
  final Dio _dio;

  // Future<void> getWelcome({VoidCallback? onTokenExpired}) async {
  //   try {
  ...
  //     final response = await _dio.get<Map<String, dynamic>>('user/Welcome');
